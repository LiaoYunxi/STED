...
class scTopicBERT():
    ...
    def transform(self,embedding_file = None,input_df=None,
        ...
        if similarity=="cosine":
            ...
            if sim_matrix.shape[1] == self.model.topic_embeddings_.shape[0]:
        ...
        if probabilities.shape[0] == self.model.topic_embeddings_.shape[0]:
            self.topic_sample_mat = probabilities
        else:
