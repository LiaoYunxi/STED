...
class scTopic():
    ...
    def trainLDA(self,indicator_selection="accuracy",random_state=9,
                 alpha=None,eta=None,
                 refresh=10,seed_confidence=0.15,
                 n_iter=100,n_ensemble=10,ntopics=None,
        ...
        if len(self.anchor_dict) < 1:
            ...
            if n_ensemble<1:
                NAlda.conduct_train(self.gene2id,self.model_dir,ntopics,n_iter=n_iter,random_state =random_state)
                self.model = NAlda
                ...
                if benchmark:
                    NAlda.benchmark(self.gene2id,self.model_dir,self.ntopics_list,n_ensemble)
                    # self.accuracy_bayes_dict = NAlda.accuracy_bayes_dict
                    # self.accuracy_bayesnorm_dict = NAlda.accuracy_bayesnorm_dict
            ...
            if benchmark:
                ...
                Alda.conduct_train(self.model_dir,ntopics,seed_topics,n_iter,ll_plot,random_state)
